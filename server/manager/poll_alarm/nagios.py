...
logger = logging.getLogger('poll_alarm.event.nagios')


class NagiosEventAlarm(BasePollAlarm):
    ...
    def __init__(self, alarm, cc_biz_id):
        ...
        '''
        super(NagiosEventAlarm, self).__init__()
        self.cc_biz_id = cc_biz_id
        self.alarm = alarm
        logger.debug('nagios get data is: %s' % self.alarm)
