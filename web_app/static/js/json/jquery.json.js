...
var JSONFormat = (function(){
    ...
    function _format_array(object, indent_count){
        ...
        return '<span data-type="array" data-size="' + tmp_array.length + '"><i  style="cursor:pointer;" class="bk-icon icon-minus-square" onclick="hide(this)"></i>[<br/>'
            + tmp_array.join(',<br/>')
    ...
    function _format_object(object, indent_count){
        ...
        return '<span  data-type="object"><i  style="cursor:pointer;" class="bk-icon icon-minus-square" onclick="hide(this)"></i>{<br/>'
            + tmp_array.join(',<br/>')
            + '<br/>' + indent_tab(indent_count - 1) + '}</span>';
    }
...
function hide(obj){
    ...
    if (data_type === 'array') {
        obj.parentNode.innerHTML = '<i  style="cursor:pointer;" class="bk-icon icon-plus-square" onclick="show(this)"></i>Array[<span class="json_number">' + data_size + '</span>]';
    }else{
        obj.parentNode.innerHTML = '<i  style="cursor:pointer;" class="bk-icon icon-plus-square" onclick="show(this)"></i>Object{...}';
    }
