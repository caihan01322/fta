            ...
            options.template = '<div class="daterangepicker dropdown-menu">' +
                '<div class="calendar left">' +
                    '<div class="daterangepicker_input">' +
                      ...
                      '<i class="bk-icon icon-calendar-shape glyphicon glyphicon-calendar"></i>' +
                      '<div class="calendar-time">' +
                        '<div></div>' +
                        '<i class="bk-icon icon-clock-shape glyphicon glyphicon-time"></i>' +
                      '</div>' +
                    '</div>' +
    ...
    DateRangePicker.prototype = {
        ...
        renderCalendar: function(side) {
            ...
            if (!minDate || minDate.isBefore(calendar.firstDay)) {
                html += '<th class="prev available"><i class="bk-icon icon-arrows-m-left-shape glyphicon glyphicon-chevron-left"></i></th>';
            } else {
                html += '<th></th>';
            }
            ...
            if (!maxDate || maxDate.isAfter(calendar.lastDay)) {
                html += '<th class="next available"><i class="bk-icon icon-arrows-m-right-shape glyphicon glyphicon-chevron-right"></i></th>';
            } else {
                html += '<th></th>';
            }
